...
if __name__ == '__main__':
    ...
    for time in range(0, last_time):
        print(time)
        evaluation_head, evaluation_tail = Test.evaluate(test_TKG[time],train_TKG[time] + valid_TKG[time] +test_TKG[time], relation2id, entity2id,time)
    ...
    # print(head_pre_result)
    # print(tail_pre_result)
